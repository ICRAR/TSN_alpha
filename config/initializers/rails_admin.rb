# RailsAdmin config file. Generated on March 05, 2013 16:13
# See github.com/sferik/rails_admin for more informations

require Rails.root.join('lib', 'rails_admin_publish_news.rb')
...
RailsAdmin.config do |config|
  ...
  config.excluded_models = ['Galaxy', 'GalaxyArea', 'GalaxyUser', 'GalaxyAreaUser', "GalaxyRegister","ProfileTrophy","Receipt","GalaxyImageFilter","BoincResult", "ChallengeData", "TheSkyMap::PlayersQuadrant"]
  ...
  config.actions do
    ...
    publish_news do
      ...
      visible do
        bindings[:abstract_model].model.to_s == "News"
      end
    end
  end
