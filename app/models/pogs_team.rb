...
# attr_accessible :title, :body
  ...
  def copy_to_local(local = nil,boinc_stats_item_hash = nil)
    ...
    profile = Profile.joins{general_stats_item.boinc_stats_item}.where{boinc_stats_items.boinc_id == leader_boinc_id}.readonly(false).first
    unless profile.nil?
  ...
  def update_memberships(alliance = nil,boinc_stats_item_hash = nil)
    ...
    alliance.update_column(:pogs_update_time, max_update_time) unless alliance.pogs_update_time == max_update_time
  end
