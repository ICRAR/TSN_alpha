...
CREATE TABLE `general_stats_items` (
  ...
  KEY `rank_asc` (`rank`),
  KEY `id_index` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=21512 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `users` (
  ...
  KEY `id_index` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=21513 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
